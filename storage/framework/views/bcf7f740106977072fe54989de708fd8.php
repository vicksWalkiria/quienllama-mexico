<?php $__env->startSection('title', 'Directorio de Claves LADA de México (IFT) - Códigos de Área'); ?>
<?php $__env->startSection('meta_description', 'Guía oficial y completa de claves LADA y códigos de área de México según el IFT. Consulta de qué ciudad o estado te llaman a 10 dígitos y números reportados.'); ?>
...
<div class="content-tool">
    ...
    <nav style="font-size:0.85rem; color:var(--text-muted); margin-bottom:1.25rem">
        <a href="<?php echo e(route('home')); ?>" style="color:var(--primary); text-decoration:none; font-weight:700">Inicio</a>
    ...
    <div class="top-codes-grid">
        <?php $__currentLoopData = $topCodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('area-codes.show', $code)); ?>" class="code-card">
                <div class="code-digit-badge"><?php echo e($code); ?></div>
                <div class="code-info-text">
                    <strong><?php echo e($info['city']); ?></strong>
                    <span><?php echo e($info['region']); ?></span>
                </div>
            </a>
    ...
    <section id="directorySections">
        <?php $__currentLoopData = $grouped; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $region => $codes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="region-block" data-region="<?php echo e(Str::lower($region)); ?>">
                <div class="region-title">
                    <span>🇲🇽</span>
                    <span><?php echo e($region); ?></span>
                    <span style="font-size:0.8rem; font-weight:600; color:var(--text-muted); margin-left:auto">
                        <?php echo e(count($codes)); ?> claves LADA
                    </span>
                </div>

                <div class="sub-codes-flex">
                    <?php $__currentLoopData = $codes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c => $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('area-codes.show', $c)); ?>" class="sub-code-item" data-code="<?php echo e($c); ?>" data-city="<?php echo e(Str::lower($d['city'])); ?>" data-reg="<?php echo e(Str::lower($region)); ?>">
                            <span class="sub-code-digit">LADA <?php echo e($c); ?></span>
                            <span class="sub-code-city" title="<?php echo e($d['city']); ?>"><?php echo e($d['city']); ?></span>
                        </a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /media/victor/externo/webs/quienllama-mexico/resources/views/area_codes/index.blade.php ENDPATH**/ ?>