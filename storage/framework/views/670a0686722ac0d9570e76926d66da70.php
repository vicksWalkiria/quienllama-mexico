<?php $__env->startSection('title', 'Bloqueador Masivo de Llamadas Spam en México (.VCF) - QuiénLlama'); ?>
<?php $__env->startSection('meta_description', 'Descarga gratis la lista de contactos VCF con los números spam más activos en México. Bloquea llamadas molestas en tu celular Android o iPhone en 1 minuto.'); ?>
    ...
    <div class="content-tool">
        ...
        <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(260px, 1fr)); gap:1.5rem; margin-bottom:3.5rem">
            ...
            <div style="background:white; border:1px solid var(--border); border-radius:var(--radius-lg); padding:2rem; text-align:center; box-shadow:var(--shadow-sm)">
                ...
                <a href="<?php echo e(route('vcf.download', 'top50')); ?>" class="btn btn-outline" style="width:100%">
            ...
            <div style="background:white; border:2px solid var(--primary); border-radius:var(--radius-lg); padding:2rem; text-align:center; box-shadow:var(--shadow-md); position:relative">
                ...
                <a href="<?php echo e(route('vcf.download', 'top100')); ?>" class="btn btn-primary" style="width:100%">
            ...
            <div style="background:white; border:1px solid var(--border); border-radius:var(--radius-lg); padding:2rem; text-align:center; box-shadow:var(--shadow-sm)">
                ...
                <a href="<?php echo e(route('vcf.download', 'top500')); ?>" class="btn btn-outline" style="width:100%">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /media/victor/externo/webs/quienllama-mexico/resources/views/vcf/index.blade.php ENDPATH**/ ?>