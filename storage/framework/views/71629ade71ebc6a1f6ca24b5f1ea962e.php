<?php $__env->startSection('title', 'Contacto y Soporte - QuiénLlama México'); ?>
<?php $__env->startSection('meta_description', '¿Tienes alguna consulta, error que reportar o sugerencia para QuiénLlama México? Contáctanos a través de nuestro formulario oficial.'); ?>
    ...
    <div class="contact-card">
        ...
        <form action="<?php echo e(route('contact.submit')); ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" required placeholder="Ej: Martín Rodríguez" class="form-control" value="<?php echo e(old('name')); ?>">
            </div>

            <div class="form-group">
                <label for="email" class="form-label">Tu Correo Electrónico (*)</label>
                <input type="email" id="email" name="email" required placeholder="ejemplo@dominio.com" class="form-control" value="<?php echo e(old('email')); ?>">
            ...
            <div class="form-group">
                ...
                <textarea id="message" name="message" rows="5" required minlength="10" placeholder="Explica detalladamente tu consulta, adjuntando el número afectado si corresponde..." class="form-control"><?php echo e(old('message')); ?></textarea>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /media/victor/externo/webs/quienllama-mexico/resources/views/contact.blade.php ENDPATH**/ ?>