...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Quién Llama México - ¿De quién es este número? Identificador Gratis'); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', 'Descubre gratis quién te llama en México. Identificador comunitario de celulares y números fijos, denuncias de extorsión, spam telefónico, cobranza y telemarketing.'); ?>">
    ...
    <meta property="og:title" content="<?php echo $__env->yieldContent('title', 'Quién Llama México - ¿De quién es este número?'); ?>">
    <meta property="og:description" content="<?php echo $__env->yieldContent('meta_description', 'Descubre gratis quién te llama en México. Identificador comunitario de celulares y números fijos, denuncias de extorsión, spam y bancos.'); ?>">
    ...
    <meta name="twitter:title" content="<?php echo $__env->yieldContent('title', 'Quién Llama México - ¿De quién es este número?'); ?>">
    <meta name="twitter:description" content="<?php echo $__env->yieldContent('meta_description', 'Descubre gratis quién te llama en México. Identificador comunitario de celulares y números fijos, denuncias de extorsión, spam y bancos.'); ?>">
    ...
    <link rel="icon" type="image/png" sizes="192x192" href="<?php echo e(asset('images/icon-192x192.png')); ?>">
    <link rel="icon" type="image/png" sizes="512x512" href="<?php echo e(asset('images/icon-512x512.png')); ?>">
    ...
    <link rel="alternate" type="text/plain" href="<?php echo e(url('/llms.txt')); ?>" title="Documentación para LLMs e IA">
    ...
    <script type="application/ld+json">
    {
        ...
        "url": "<?php echo e(url('/')); ?>",
        "logo": "<?php echo e(asset('images/icon-512x512.png')); ?>",
        "founder": {
            "@type": "Person",
            "name": "Víctor Alonso",
    ...
    <script>
        ...
        function loadGTM() {
            if (!window.gtmLoaded) {
                ...
                s.src = 'https://www.googletagmanager.com/gtag/js?id=<?php echo e($gaId); ?>';
                s.async = true;
...
<body>
    ...
    <header class="site-header">
        <div class="header-inner">
            ...
            <div class="header-search-wrapper">
                <form action="<?php echo e(route('search')); ?>" method="GET" class="header-search-form">
                    <input type="text" name="q" placeholder="Buscar celular o número fijo (ej: 55 1234 5678)..." value="<?php echo e(request('q')); ?>" autocomplete="off" required>
            ...
            <nav class="header-nav" id="header-nav">
                <a href="<?php echo e(route('home')); ?>">Buscar</a>
                <a href="<?php echo e(route('area-codes.index')); ?>">Claves LADA IFT</a>
                <a href="<?php echo e(route('vcf.index')); ?>">Bloquear SPAM</a>
                <a href="<?php echo e(route('legal.no-molestar')); ?>">PROFECO REPEP</a>
                <a href="<?php echo e(route('legal.about')); ?>">Sobre mí</a>
                <a href="<?php echo e(route('contact.index')); ?>" class="nav-btn-highlight">Contacto</a>
            </nav>
        </div>
    </header>
    ...
    <footer class="site-footer">
        <div class="footer-grid">
            ...
            <div class="footer-col">
                <h4>Herramientas</h4>
                <ul>
                    <li><a href="<?php echo e(route('home')); ?>">Buscador de Teléfonos</a></li>
                    <li><a href="<?php echo e(route('area-codes.index')); ?>" style="color:var(--primary); font-weight:700">Claves LADA de México (IFT)</a></li>
                    <li><a href="<?php echo e(route('vcf.index')); ?>">Bloqueador SPAM VCF (Top México)</a></li>
                    <li><a href="<?php echo e(route('legal.no-molestar')); ?>">Guía REPEP PROFECO / REUS CONDUSEF</a></li>
                </ul>
            </div>
            ...
            <div class="footer-col">
                ...
                <ul>
                    <li><a href="<?php echo e(route('area-codes.show', '55')); ?>">CDMX y Valle de México (+52 55)</a></li>
                    <li><a href="<?php echo e(route('area-codes.show', '33')); ?>">Guadalajara y Zapopan (+52 33)</a></li>
                    <li><a href="<?php echo e(route('area-codes.show', '81')); ?>">Monterrey y San Pedro (+52 81)</a></li>
                    <li><a href="<?php echo e(route('area-codes.show', '222')); ?>">Puebla y Cholula (+52 222)</a></li>
                    <li><a href="<?php echo e(route('area-codes.show', '442')); ?>">Querétaro (+52 442)</a></li>
                    <li><a href="<?php echo e(route('area-codes.show', '664')); ?>">Tijuana (+52 664)</a></li>
                    <li><a href="<?php echo e(route('area-codes.show', '998')); ?>">Cancún y Riviera Maya (+52 998)</a></li>
                    <li><a href="<?php echo e(route('area-codes.show', '999')); ?>">Mérida y Progreso (+52 999)</a></li>
                </ul>
            </div>
            ...
            <div class="footer-col">
                ...
                <ul>
                    <li><a href="<?php echo e(route('legal.about')); ?>" style="color:var(--primary); font-weight:700">Sobre el Desarrollador (EEAT)</a></li>
                    <li><a href="<?php echo e(route('contact.index')); ?>">Contacto y Soporte</a></li>
                    <li><a href="<?php echo e(route('legal.terminos')); ?>">Aviso Legal y Términos</a></li>
                    <li><a href="<?php echo e(route('legal.privacidad')); ?>">Política de Privacidad</a></li>
                    <li><a href="<?php echo e(route('legal.cookies')); ?>">Política de Cookies</a></li>
                    <li><a href="<?php echo e(url('/llms.txt')); ?>">Documentación AI (llms.txt)</a></li>
    ...
    <script src="<?php echo e(asset('js/analytics_events.js')); ?>" defer></script>

    <?php echo $__env->yieldContent('scripts'); ?>
</body>
</html>
<?php /**PATH /media/victor/externo/webs/quienllama-mexico/resources/views/layouts/app.blade.php ENDPATH**/ ?>